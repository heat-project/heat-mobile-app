...
using HeatApp.Models.AboutUs;
using Xamarin.Forms;
using Xamarin.Forms.Internals;

namespace HeatApp.ViewModels.AboutUs
{
    /// <summary>
    ...
    public class AboutUsViewModel : BaseViewModel
    {
        ...
        /// <summary>
        /// Initializes a new instance for the <see cref="T:HeatApp.ViewModels.AboutUs.AboutUsViewModel"/> class.
        /// </summary>
